...
[model_m3_eval_predictions.csv](https://raw.githubusercontent.com/datafeelings/CUNY_DATA_621_Data_Mining/master/Week_12/model_m3_eval_predictions.csv)
...
The output of the model on the evaluated data is available under the following URL:
[model_m1_cont_eval_predictions.csv](https://raw.githubusercontent.com/datafeelings/CUNY_DATA_621_Data_Mining/master/Week_12/model_m1_cont_eval_predictions.csv)

### Appendix

The full R code for the analysis in Rmd format is available under the following URL:
[hw4_insurance_data.Rmd](https://github.com/datafeelings/CUNY_DATA_621_Data_Mining/blob/master/Week_12/hw4_insurance_data.Rmd)
